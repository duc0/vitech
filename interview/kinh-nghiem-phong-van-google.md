...
[](http://vnoi.info/wiki/interview/Kinh-nghiem-phong-van-Google#0-quy-tr%C3%ACnh-ph%E1%BB%8Fng-v%E1%BA%A5n-google)0\. Quy trình phỏng vấn Google
================================================================================================================================================
...
[](http://vnoi.info/wiki/interview/Kinh-nghiem-phong-van-Google#1-chu%E1%BA%A9n-b%E1%BB%8B)1\. Chuẩn bị
=======================================================================================================
...
[](http://vnoi.info/wiki/interview/Kinh-nghiem-phong-van-Google#1-chu%E1%BA%A9n-b%E1%BB%8B_1-1-thu%E1%BA%ADt-to%C3%A1n)1.1. Thuật toán
--------------------------------------------------------------------------------------------------------------------------------------
...
-   Phân tích thuật toán, cả tốc độ và thời gian chạy. Có thể tham khảo thêm [bài viết về độ phức tạp tính toán trên VNOI wiki](http://vnoi.info/wiki/translate/topcoder/Computational-Complexity-Section-1).
...
Lời giải bài này các bạn có thể tìm thấy trên [VNOI wiki](http://vnoi.info/wiki/algo/dp/palindrome-problems). Với các bạn dân ACM khi gặp bài này, nên tránh những thuật toán như [Hash](http://vnoi.info/wiki/algo/string/hash), vì có thể người phỏng vấn sẽ thắc mắc những vấn đề như đánh giá độ chính xác. Bạn cũng nên tránh thuật toán không phổ biến như Manacher.

[](http://vnoi.info/wiki/interview/Kinh-nghiem-phong-van-Google#1-chu%E1%BA%A9n-b%E1%BB%8B_1-2-ti%E1%BA%BFng-anh)1.2. Tiếng Anh
-------------------------------------------------------------------------------------------------------------------------------
...
[](http://vnoi.info/wiki/interview/Kinh-nghiem-phong-van-Google#1-chu%E1%BA%A9n-b%E1%BB%8B_1-3-c%C3%A1c-ki%E1%BA%BFn-th%E1%BB%A9c-kh%C3%A1c)1.3. Các kiến thức khác
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](http://vnoi.info/wiki/interview/Kinh-nghiem-phong-van-Google#2-n%E1%BB%99p-resume)2\. Nộp Resume
===================================================================================================

[](http://vnoi.info/wiki/interview/Kinh-nghiem-phong-van-Google#2-n%E1%BB%99p-resume_2-1-so%E1%BA%A1n-resume)2.1. Soạn Resume
-----------------------------------------------------------------------------------------------------------------------------
...
[](http://vnoi.info/wiki/interview/Kinh-nghiem-phong-van-Google#2-n%E1%BB%99p-resume_2-2-ki%E1%BA%BFm-ng%C6%B0%E1%BB%9Di-refer)2.2. Kiếm người refer
----------------------------------------------------------------------------------------------------------------------------------------------------
...
[](http://vnoi.info/wiki/interview/Kinh-nghiem-phong-van-Google#3-ph%E1%BB%8Fng-v%E1%BA%A5n)3\. Phỏng vấn
=========================================================================================================
...
Mình sẽ lấy ví dụ về mặt cài đặt bằng bài toán tìm xâu con đối xứng dài nhất với độ phức tạp (N2)O(N2) ở phần 1:
...
[](http://vnoi.info/wiki/interview/Kinh-nghiem-phong-van-Google#4-host-matching)4\. Host matching
=================================================================================================
